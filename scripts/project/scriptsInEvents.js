...
const scriptsInEvents = {
	...
	async Es_loader_Event9_Act1(runtime, localVars)
	{
	...
	async Es_game_Event445_Act1(runtime, localVars)
	{
		PokiSDK.customEvent('game', 'segment', { segment: 'level'+runtime.globalVars.Levels_Completed_Count });
	}
